...
%% \begin{itemize}
%% \item[] 2014 -- Accepted delivery of 184 nodes, 3,800 cores  
%% \item[] 2015 -- Opened for general use
%% \item[] 2016 -- 92 nodes added, 5,876 cores
%% \item[] 2017 -- 14 nodes added, 6,172 cores 
%% %\item[] 2018
%% %  \begin{itemize}
%% %  \item Apr. -- 549$+$ users have been granted access to the cluster
%% %  \end{itemize}
%% \end{itemize}
%% \end{frame}
