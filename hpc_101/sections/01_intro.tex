...
\begin{frame}
  ...
  \item Long Term Storage (LTS)
    \begin{itemize}
    \item {\textbf{Purpose}}: \footnotesize Additional Personal and/or group storage for applications and active data when all other storage options have been exhausted{\mana}\footnote{\label{LTS}\tiny\ \url{https://hawaii.kualibuild.com/app/builder/app/6062a8170d0d97001cb7d3af/run}}
