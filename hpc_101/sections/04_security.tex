...
\begin{frame}
  ...
  \vspace{-5pt}
  \begin{block}{Protected Data}
    Collecting, managing, sharing or using  data that can be classified in a protected data category the Data Governance Process (DGP) is required 
  \end{block}
\end{frame}  
...
\section{UH Data Related Policies \& Procedures}
\begin{frame}
...
\makebox[\linewidth][c]{
    \resizebox{\textwidth}{!}{%                                                                                                                                                                                                                                                       
      ...
      %  \multicolumn{8}{c}{ {\large {\textbf{UH-HPC Resource Summary} } } } \\                                                                                                                                                                                                       
        ...
        \midrule \midrule
        \textbf{AP2.215} & Mandatory Training \& Continuing Education Requirements \\
        \midrule
        \textbf{AP7.022} & FERPA \\
        \midrule \midrule
        ...
        \midrule
        \href{}{\textbf{EP2.213}} & System and Campus Wide Electronic Channels for Communicating with Students\\
        \midrule        
        \textbf{EP2.214} & Data Classification Categories \& Information Security Guidelines \\
        \midrule
        \textbf{EP2.215} & Institutional Data Governance \\
        \midrule
        \textbf{EP2.216} & Institutional Records Management \& Electronic Approvals/Signatures (\textit{Pending Approval}) \\
        \midrule
