...
\item[] \texttt{module show \pth{module name}} \desc{Shows you what actions the module performs to your environment}
...
\subsection{Commands}
\begin{itemize}
\item[] \texttt{less \pth{file}} \desc{Show contents of file\\Navigate using up/down arrow keys, spacebar, or pageup/pagedown keys\\Press 'q' to exit out of less}
\item[] \texttt{less -S \pth{file}} \desc{Show contents of file without line wrap\\Navigate using up/down arrow keys, spacebar, or pageup/pagedown keys\\Press 'q' to exit out of less}
\item[] \texttt{man \pth{command}} \desc{Show the manual entry (if one exists) for the given command\\Press 'q' to exit out of less}
\end{itemize}
