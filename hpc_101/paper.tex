...
\begin{frame}
	...
	\begin{itemize}\footnotesize
        ...
        \item Allocate exclusive and/or non-exclusive access to resources to users for some duration of time so they can perform work
	\item Provides a framework for starting, executing, and monitoring work on the set of allocated resources
