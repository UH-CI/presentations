...
\begin{frame}
	...
	\end{itemize}
	\bigskip
	For the {\craycs}, we utilize the \textbf{S}imple \textbf{L}inux \textbf{U}tility for \textbf{R}esource \textbf{M}anager~\\ or simply known as the \emph{SLURM scheduler}
