...
\begin{itemize}
	...
	\item Require a single node, in which they use multiple threads work together (OpenMP, pthreads, TBB)
...
~\\
~\\
This looks like a job for a \textbf{\emph{job scheduler}}!
\end{frame}
...
\begin{frame}
	...
	\end{itemize}
	For the Cray CS300, we utilize the \textbf{S}imple \textbf{L}inux \textbf{U}tility \textbf{R}esource \textbf{M}anager~\\ or simply known as the \emph{SLURM scheduler}.
...
\end{block}
\begin{itemize}
	\item The Cray CS300 currently has six public partitions:~\\\textbf{lm.q}, \textbf{community.q}, \textbf{exclusive.q}, \textbf{sb.q}, \textbf{kill.q}, \textbf{htc.q}
