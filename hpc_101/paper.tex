...
\hline
lm.q & \begin{tabular}{l r}\textbf{Default} & 0-00:10:00~\\ \textbf{Max} & 3-00:00:00\end{tabular} &  \begin{tabular}{c  c}\textbf{Min} & \padfrom{\ \ \ }{1}~\\ \textbf{Max} &\padfrom{\ \ \ }{1}\end{tabular} & 10 & NO & REQUEUE & \begin{tabular}{l c}\textbf{Default} & \padfrom{\ \ \ \ \ \ \ \ \ }{$\infty$}~\\ \textbf{Max} & \padfrom{\ \ \ \ \ \ }{262100}\end{tabular}\\
\hline
sb.q & \begin{tabular}{l r}\textbf{Default} & 0-00:05:00~\\ \textbf{Max} & 0-01:00:00\end{tabular} &  \begin{tabular}{c  c}\textbf{Min} & \padfrom{\ \ \ }{1}~\\ \textbf{Max} &\padfrom{\ \ \ }{2}\end{tabular} & 10 & NO & REQUEUE & \begin{tabular}{l c}\textbf{Default} & \padfrom{\ \ \ \ \ \ \ }{3250}~\\ \textbf{Max} & \padfrom{\ \ \ \ \ \ \ }{6500}\end{tabular}\\
\bottomrule 
\end{tabular}   
}
\\
