...
\newcommand{\ci}{Research Cyberinfrastructure}
\newcommand{\citeam}{RCI--Team}
...
\include{sections/02_interaction}
\include{sections/03_policies}
%\include{sections/04_security}
