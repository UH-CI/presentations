...
If you already use Globus, the endpoints for the {\craycs} are:
\begin{itemize}
\item hawaii\#UHHPC1
\item hawaii\#UHHPC1
\end{itemize}
~\\ 
For those that have not used Globus, and wish to try it out, you can learn how to use Globus by visiting the {\ci} website for more information:~\\
...
\end{itemize}
\bigskip
The {\craycs} is capable of handling many different types of jobs, but with so many users in a multi-user environment, how do we turn this chaos into organized chaos?
\btVFill
...
\begin{itemize}
	...
	\item More details on partition constraints can be viewed by visiting the \href{http://www.hawaii.edu/its/ci/hpc-resources/slurm-partitions/}{{\ci} website} or by using the following command
	\begin{itemize}\footnotesize
