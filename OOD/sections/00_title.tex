...
\title[Open OnDemand]{Open OnDemand} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\textbf{\url{http://datascience.hawaii.edu/}}\\
